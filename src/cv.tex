...
\newenvironment{threecols}
    ...
    \begin{longtable}[h]{%
        ...
        >{\raggedleft}p{\firstColumnWidth}%
        @{\hspace{\tabusep}}%
        >{\raggedright}p{0.5\dimexpr %
            (\linewidth-\firstColumnWidth-2\tabusep)%
        \relax}%
        @{\hspace{\tabusep}}%
        >{\raggedright}p{0.5\dimexpr %
            (\linewidth-\firstColumnWidth-2\tabusep)%
...
\begin{center}
	\Tr{\LARGE \scshape {Utku Birkan}} \vspace{.5em}
	
    Mutlukent, 1958. Sk, No:5 \\
    06800, Çankaya / Ankara, TR \\
	\href{mailto:utku.birkan@gmail.com}{utku.birkan@gmail.com}\\
    \href{https://github.com/kurabirko}{\faIcon{github}\hskip 2px kurabirko}
\end{center}
